...
/**********************************************/
LIBNAME LIBRARY 'C:\Users\HP375\Partners HealthCare Dropbox\Omar Hyder\Research\HCUP Master Files\Elixhauser 2026-1';                  * Location of format library.       <===USER MUST MODIFY;	   
...
* Specify the maximum number of diagnosis codes
  on any record in the input file. ;                       %LET NUMDX = 30;       *<===USER MUST MODIFY;
...
/*          SPECIFY FILE NAMES                */
/**********************************************/
* Input SAS file member name;                              %Let CORE = md2016_final; *<===USER MUST MODIFY;            
* Output SAS file member name;                             %Let OUT  = md2016_final_CMR;*<===USER MUST MODIFY;
